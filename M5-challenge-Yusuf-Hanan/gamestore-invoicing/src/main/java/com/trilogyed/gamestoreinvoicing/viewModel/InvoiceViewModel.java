...
public class InvoiceViewModel {
    ...
    public InvoiceViewModel(String name, String street, String city, String state, String zipcode, String itemType, long itemId, BigDecimal unitPrice, long quantity) {
        this.name = name;
        this.street = street;
        this.city = city;
        this.state = state;
